#!/usr/bin/env bash
#SBATCH -J rlinf_ctrl_world_pi05_eval
...
# Weights & Biases auth (same key style as training script)
...
CONFIG_NAME="${CONFIG_NAME:-ctrl_world_libero_spatial_grpo_openpi_pi05_eval}"
