...
from rlinf.models.embodiment.openpi.dataconfig.book_dataconfig import (
    LeRobotBookDataConfig,
)
...
from rlinf.models.embodiment.openpi.dataconfig.ur5_realworld_dataconfig import (
    LeRobotUR5RealWorldDataConfig,
)
...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotBookDataConfig(
            repo_id="lerobot_book",
            base_config=DataConfig(prompt_from_task=True),
            assets=AssetsConfig(assets_dir="checkpoints/torch/pi05_book/assets"),
            extra_delta_transform=True,
        ),
        batch_size=256,
        lr_schedule=_optimizer.CosineDecaySchedule(
